...
if __name__ == '__main__':
    ...
    final_model.summary()
    # get the implicit relations and long-distance dependencies of training set and independent test set
    w_vector = final_model.predict(train_bert)
    ind_w_vector = final_model.predict(test_bert)
    np.save('implicit_information_train.npy', w_vector)
    np.save('implicit_inforamtion_test.npy', ind_w_vector)
